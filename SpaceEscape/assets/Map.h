...
//......
const uint8_t map3[] = {
    OOB,    EDGE_R, FLOOR0, INN_DL, EDGE_D, OUT_DL,
    OOB,    EDGE_R, FLOOR0, FLOOR0, FLOOR0, EDGE_L,
    OOB,    EDGE_R, FLOOR0, INN_UL, EDGE_U, OUT_UL,
    OOB,    EDGE_R, FLOOR0, INN_DL, EDGE_D, EDGE_D,
    OOB,    EDGE_R, FLOOR0, FLOOR0, FLOOR0, FLOOR0,
    OOB,    OUT_UR, EDGE_U, EDGE_U, EDGE_U, EDGE_U,
};
const uint8_t entrances_room3[] = {2, 4, 0, 0};
const Room room3(6, 6, entrances_room3, map3);
...
const uint8_t map4[] = {
    ...
    OOB,    OOB,    OOB,    OOB,    OUT_UR, EDGE_U, OUT_UL, OOB,    OOB,    OOB,    OOB,    OOB,    OOB,    OOB,    OOB,    OOB,
    ...
    OOB,    OOB,    OOB,    OUT_DR, EDGE_D, OUT_UL, OOB,    EDGE_R, FLOOR0, INN_DL, INN_DR, FLOOR0, EDGE_L, OUT_UR, EDGE_U, OUT_UL,
    OOB,    OOB,    OOB,    EDGE_R, FLOOR0, INN_DL, EDGE_D, INN_DR, FLOOR0, FLOOR0, FLOOR0, FLOOR0, EDGE_L, OOB,    OOB,    OOB,
    OOB,    OOB,    OOB,    EDGE_R, FLOOR0, FLOOR0, FLOOR0, FLOOR0, FLOOR0, OOB,    EDGE_U, EDGE_U, OUT_UL, OOB,    OOB,    OOB,
